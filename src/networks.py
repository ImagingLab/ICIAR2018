...
class PatchWiseNetwork64(nn.Module):
    def __init__(self):
        super(PatchWiseNetwork64, self).__init__()
...
class ImageWiseNetwork64(nn.Module):
    def __init__(self):
        super(ImageWiseNetwork64, self).__init__()
